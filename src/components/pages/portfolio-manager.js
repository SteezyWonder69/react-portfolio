...
export default class PortfolioManager extends Component {
    ...
    getPortfolioItems() {
        axios.get('https://spencersuckow.devcamp.space/portfolio/portfolio_items', {withCredentials: true})
        // optional params for the api call : ?order_by=created_at&direction=desc
            .then(response => {
                // handle success
                this.setState({
