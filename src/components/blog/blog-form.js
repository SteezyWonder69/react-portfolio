...
export default class BlogForm extends Component {
    constructor() {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://spencersuckow.devcamp.space/portfolio/portfolio_blogs",
            apiAction: "post"
        }
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://spencersuckow.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
                apiAction: "patch"
            })
        }
    }
